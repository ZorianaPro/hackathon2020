...
const AddNewIdea = ({ team, dispatch, isOpen, id, errorMessage }) => {
  ...
  const addNewIdea = useCallback((e) => {
    e.preventDefault();
    setSubmitForm(true);
    return false;
  }, []);
          ...
          <div className="Overlay-Container">
            {!showThankYou && (
              <div className="Overlay-Box">
                ...
                <div className="AddNewIdea-Title">Add new idea</div>
                {errorMessage}
